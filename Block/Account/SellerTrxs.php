...
/**
 * Seller Transactions block
 *
 * @api
 * @since 100.0.2
 */
class SellerTrxs extends \Magento\Framework\View\Element\Template
{
    ...
    {
        parent::_construct();
        $this->pageConfig->getTitle()->set(__('Seller Transactions'));
    }
    ...
    {
        return $this->getUrl('marketplace/order/view', ['id' => $order->getOrderId()]);
    }
