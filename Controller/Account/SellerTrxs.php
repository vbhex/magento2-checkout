...
/**
 * Dservice Account SellerTrxs Controller.
 */
class SellerTrxs extends \Magento\Customer\Controller\AbstractAccount
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->set(__('Dservice Seller Transactions List Page'));
