 ...
 */
namespace Vbhex\Checkout\Model\ResourceModel\Order;
...
/**
 * Vbhex Checkout ResourceModel Order collection
 */
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Vbhex\Checkout\Model\Order::class,
    ...
    /**
     * Retrieve all order_id for collection
     *
     * @param int|string $limit
     * @param int|string $offset
     * @return array
    ...
    /**
     * Join with Magento Sales Order Grid Flat Table
     */
    public function joinSaleOrder()
    {
        $joinTable = $this->getTable('sales_order');
        $this->getSelect()->join($joinTable.' as so', 'main_table.order_id = so.entity_id');
    }
